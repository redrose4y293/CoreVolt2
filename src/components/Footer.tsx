...
<div className="flex items-center gap-4">
  ...
  <a
    ...
    aria-label="Facebook"
  >
    <svg className="w-6 h-6 text-2xl" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
      <path d="M22 12.07C22 6.48 17.52 2 11.93 2S2 6.48 2 12.07c0 4.99 3.66 9.13 8.44 9.93v-7.03H8.08v-2.9h2.36V9.41c0-2.33 1.39-3.62 3.52-3.62 1.02 0 2.09.18 2.09.18v2.3h-1.18c-1.16 0-1.52.72-1.52 1.46v1.74h2.59l-.41 2.9h-2.18V22c4.78-.8 8.44-4.94 8.44-9.93z"/>
    </svg>
  </a>
  ...
  >
    <svg className="w-6 h-6 text-2xl" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
      <path d="M22 5.92c-.63.28-1.3.47-2 .56.72-.43 1.26-1.1 1.52-1.9-.67.4-1.4.7-2.18.86C18.6 4.34 17.73 4 16.78 4c-1.65 0-3 1.34-3 3 0 .24.03.47.08.69C10.8 7.3 8.07 6 5.74 3.54c-.32.55-.5 1.2-.5 1.87 0 1.29.65 2.43 1.66 3.07-.6 0-1.19-.18-1.7-.48v.05c0 1.78 1.26 3.26 2.91 3.59-.49.13-1 .2-1.51.2-.37 0-.73-.04-1.08-.1.73 2.28 2.85 3.93 5.36 3.98-1.96 1.54-4.44 2.45-7.14 2.45-.46 0-.91-.03-1.36-.08C6.48 19.72 9.26 20.5 12.31 20.5c7.66 0 11.86-6.14 11.86-11.86 0-.18 0-.36-.01-.54.81-.58 1.5-1.32 2.06-2.16z"/>
    </svg>
  </a>
  ...
  >
    <svg className="w-6 h-6 text-2xl" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
      <path d="M19 3A2 2 0 0 1 21 5v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14zM8.34 17v-6.3H6.2V17h2.14zM7.27 9.9c.7 0 1.13-.46 1.13-1.03-.01-.59-.43-1.03-1.12-1.03-.7 0-1.13.44-1.13 1.03 0 .57.43 1.03 1.12 1.03zM18 17v-3.3c0-1.76-1-2.6-2.35-2.6-1.09 0-1.57.6-1.84 1.03V17h2.14v-3.05c0-.8.15-1.6 1.09-1.6.95 0 1.01.92 1.01 1.64V17H18z"/>
    </svg>
  </a>

  {/* Liberty Social (inline SVG - inherits text color & hover) */}
  <a
    href="#"
